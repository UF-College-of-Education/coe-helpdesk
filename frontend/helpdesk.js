$(document).ready(function () {
    ...
    const token = await grecaptcha.enterprise.execute('6Ld7B3UmAAAAAJc7x3-EWRX2OBEJchiZRYuRlCW8', { action: 'helpdesk_submit' });
            ...
            if (datasink == "monday.com") {
                ...
                if (category == "website-edits") {
                    ...
                    if (false) {
                        ...
                        // Check if the number of files is under the limit.
                    ...
                    var cv_file_upload = form.find("input#cv_upload");
